...
import "github.com/justenwalker/mack/thirdparty"

// EncoderDecoder is an interface that combines both Encoder and Decoder functionalities for encoding and decoding operations on [EncryptedMessage] and [thirdparty.Ticket].
