// Package mack contains the core functionality of constructing and verifying a macaroon.
//
// # Create a Scheme
//
// First, you must create a `mack.Scheme`. The specification isn't prescriptive about algorithms used,
...
//
// An Authorizing Macaroon and its associated Discharge Macaroons constitute a [mack.Stack].
